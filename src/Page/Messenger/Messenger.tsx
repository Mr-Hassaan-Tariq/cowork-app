...
import ArchivePopup from "../../Component/Messenger/ArchivePopup";
import MemberInfo from "../../Component/Messenger/MemberInfo";
...
const Messenger = () => {
  ...
  const [users, setUsers] = useState<Message[]>([]); // users to be showed in the contact list
  ...
  const handleFromSet = (e: any | null) => {
    if (e) {
      setChatter(e);
      const user = {
        email: e.recipient,
  ...
  return (
    <Layout>
          ...
          <div className="contacts">
            <div className="all-messages-parent">
              <div className="d-flex">
                <div className="messageFilterDropdown">
                  <Dropdown>
                    <Dropdown.Toggle>
                      <button className="">
                        <img src={filter} alt="filter" className="m-1" />
                      </button>
                    </Dropdown.Toggle>
                    <Dropdown.Menu>
                      <Dropdown.Item>All Messages</Dropdown.Item>
                      <Dropdown.Item>Unread Messages</Dropdown.Item>
                      <Dropdown.Item>Archived Messages</Dropdown.Item>
                      <Dropdown.Item> Admin Messages</Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
                </div>
                <div className="all-messages p-1">All Messages</div>
              </div>
              <div
                className="button add-recipent"
            ...
            <div className="contact">
              {users.map((e: any, i) => (
                <div className={"contact1 "} key={i}>
                  {/* <Stack direction="horizontal" gap={3}>
                    <div className="p-2">
                      <div className="avatar">
                        <img className="avatar-icon1" src={profileLogo} />
                      </div>
                    </div>
                    <div className="p-2 ">
                      <div className="text">
                        <div className="bogdan-krivenchenko">{e.name}</div>
                        <div className="hi-how-are">{e.defaultMessage}</div>
                      </div>
                    </div>
                    <div className="p-2 ms-auto">
                      <div className="parent">
                        <div className="div16">
                          {convertTimeToReadable(e.created_at)} 
                          today
                        </div>
                  ...
                  <div className="parent">
                    <div className="div16">
                      <div className="parent">
                        ...
                        {e?.online_status ? <div className="ellipse" /> : ""}
                      </div>
                    </div>
                  </div>
                  {/* <>{e.group_id}</> */}
                  ...
                  <div className="user-parent">
                    ...
                    <div className="messageFilterDropdown">
                      ...
                      <Dropdown>
                        ...
                        <Dropdown.Menu>
                          <Dropdown.Item>
                            <button onClick={handleShow}>View Member</button>
                          </Dropdown.Item>
                          <Dropdown.Item>
                            {" "}
                            <ArchivePopup />
      ...
      <MemberInfo show={show} setShow={setShow} handleClose={handleClose} />
      <UploadFileForChat
        chatter={chatter}
        from={currentUser}
        to={to}
